...
class humanity_last_exam(base_task):
    ...
    def __init__(self, path = './data', category = 'Biology/Medicine', answer_type = 'multipleChoice'):
        if category not in ['Other', 'Humanities/Social Science', 'Math', 'Physics', 'Computer Science/AI', 'Biology/Medicine', 'Chemistry', 'Engineering']:
            raise ValueError("category must be one of ['Other', 'Humanities/Social Science', 'Math', 'Physics', 'Computer Science/AI', 'Biology/Medicine', 'Chemistry', 'Engineering']")
