...
# export CUDNN_PATH="$(/mnt/biomni_filestore/biomni/venvs/skyrl-agent/bin/python -c 'import inspect, nvidia.cudnn as c, os; print(os.path.dirname(inspect.getfile(c)))')"export CPATH="$CUDNN_PATH/include:${CPATH:-}"
