#!/usr/bin/env bash
# Biomni CodeAct 30B-A3B with GSPO + dual_clip
# Combines:
...
# ── Paths ──
PROJECT_NAME="biomni-training-qwen3-30b-a3b-skyrlagent-rubric-gspo-dualclip"
EXPERIMENT_NAME="biomni-training-qwen3-30b-a3b-8gpus-rubric-gspo-dualclip-eps2e3-cosine"
