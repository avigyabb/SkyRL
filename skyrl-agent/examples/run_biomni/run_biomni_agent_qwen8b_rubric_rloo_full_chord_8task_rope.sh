...
# 8-task variant: gwas_variant_prioritization, rare_disease_diagnosis, crispr_delivery,
# patient_gene_detection, screen_gene_retrieval, gwas_causal_gene_{opentargets,pharmaprojects,gwas_catalog}
# Task selection is controlled by TARGET_TASKS in skyrl_train/dataset/dataset.py.
...
PROJECT_NAME="biomni-training-qwen3-8b-8task-chord"
EXPERIMENT_NAME="biomni-training-qwen3-8b-16bsz-temp1.0-clip-0.28-rloo-full-chord-8task-rope"
